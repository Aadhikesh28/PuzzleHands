...
export const GameContainer: React.FC = () => {
  ...
  const [hintedPieceIdx, setHintedPieceIdx] = useState<number | null>(null);
  ...
  const misplacedPieces = pieces.filter(
    (piece) => piece.currentIdx !== piece.correctIdx
  );
  ...
  setHintedPieceIdx(randomPiece.currentIdx);
  ...
  }, [gridSize, difficulty, imageSource, artType, setPieces, setPhase, stopCameraStream]);
  ...
  <div className="grid grid-cols-3 gap-2">
    {(['easy', 'moderate', 'hard'] as const).map((diff) => {
      ...
      const details = {
        ...
        moderate: { grid: '4x4', mult: '2.0x' },
        hard: { grid: '5x5', mult: '3.0x' },
      }[diff];
          ...
          {phase === 'solve' && (
            ...
            >
              ...
              <div className="lg:col-span-3 flex flex-col gap-4">
                ...
                <button
                  onClick={handleHint}
                  disabled={phase !== 'solve' || pieces.length === 0}
              ...
              <div className="lg:col-span-6 flex flex-col items-center justify-center">
                ...
                >
                  ...
                  {pieces.map((piece) => {
                    ...
                    const isHinted = hintedPieceIdx === piece.currentIdx;

                    let borderStyle = 'border-white/10';
                    if (isSelected) {
                      borderStyle = 'border-[#10B981] z-20 shadow-[0_0_20px_#10B981] ring-2 ring-[#10B981] scale-[0.98]';
                    } else if (isHinted) {
                      borderStyle = 'border-yellow-400 z-20 shadow-[0_0_25px_#FACC15] ring-2 ring-yellow-400 animate-pulse';
